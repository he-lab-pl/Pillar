...
*   **Przełączniki:** Zdalne włączanie "Blokady Przycisków" (Child Lock).
*   **Konfiguracja:** Dostęp do dodatkowych ustawień systemowych.
...
*   Lampa potwierdzi zmianę mignięciem na kolor bursztynowy.
...
3.  Po **20 sekundach** lampa mignie na niebiesko.
